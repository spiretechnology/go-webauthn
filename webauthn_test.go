...
import (
	...
	"github.com/spiretechnology/go-webauthn/store/mocks"
)
...
func setupMocks(opts *webauthn.Options) (webauthn.WebAuthn, *mocks.MockUsers, *mocks.MockCredentials, *mocks.MockChallenges) {
	...
	return w, users, credentials, challenges
}
